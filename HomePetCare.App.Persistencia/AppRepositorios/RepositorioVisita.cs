...
namespace HomePetCare.App.Persistencia
{
    ...
    {   /// <summary>
        ...
        {
            var visitaEncontrada = _appContext.Visitas.FirstOrDefault(vi => vi.VisitaId == VisitaId);
        ...
        {
            return _appContext.Visitas.FirstOrDefault(vi => vi.VisitaId == VisitaId);
        }

        Visita IRepositorioVisita.Update(Visita visita)
        {
            var visitaEncontrada = _appContext.Visitas.FirstOrDefault(vi => vi.VisitaId == visita.VisitaId);
            if (visitaEncontrada != null)
            {
